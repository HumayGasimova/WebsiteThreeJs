...
describe('autoPaperclipsStartEpic', () => {
  ...
  it('should return a MAKE_PAPERCLIP after each second',
    ...
    //       const expectedVaues = {a: { type: actionTypes.MAKE_PAPERCLIP }, b: { type: actionTypes.MAKE_PAPERCLIP }, c: { type: actionTypes.MAKE_PAPERCLIP }, d: { type: actionTypes.MAKE_PAPERCLIP }};
    //       expectObservable(Epic.autoPaperclipsStartEpic(action$, state$)).toBe(expectedMarble, expectedVaues)
        }
      )
