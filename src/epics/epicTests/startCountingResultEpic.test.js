...
describe('startCountingResultEpic', () => {
    ...
    //             value: {
    //                 business: {
    //                     allRoundsRes: [{cell1: 30, call2: 40, cell3: 20, cell4: 10, playerLeft: {val: 2, strategy: "RANDOM"}, playerTop: {val: 2, strategy: "MINIMAX"}}]
    //                 }
    //             }
    //         }
    //         const epic$ = Epic.startCountingResultEpic(action$, state$);
    ...
    //             value: {
    //                 business: {
    //                     allRoundsRes: [{cell1: 30, call2: 40, cell3: 20, cell4: 10, playerLeft: {val: 1, strategy: "RANDOM"}, playerTop: {val: 2, strategy: "MINIMAX"}}]
    //                 }
    //             }
    //         }
    //         const epic$ = Epic.startCountingResultEpic(action$, state$);
    ...
    //             value: {
    //                 business: {
    //                     allRoundsRes: [{cell1: 30, call2: 40, cell3: 20, cell4: 10, playerLeft: {val: 2, strategy: "RANDOM"}, playerTop: {val: 1, strategy: "MINIMAX"}}]
    //                 }
    //             }
    //         }
    //         const epic$ = Epic.startCountingResultEpic(action$, state$);
