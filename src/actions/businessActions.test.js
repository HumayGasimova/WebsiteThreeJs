...
describe('businessActions', () => {
    ...
    it('Dispatches the correct action and payload (removePriceOfProjectOpsAndYomi)', () => {
        const expectedActions = [
            {
        ...
        store.dispatch(Actions.removePriceOfProjectOpsAndYomi(5, 7));
        expect(store.getActions()).toEqual(expectedActions);
        expect(store.getActions()).toMatchSnapshot();
    });
    ...
    it('Dispatches the correct action and payload (showBusinessSection)', () => {
        const expectedActions = [
            {
        ...
        store.dispatch(Actions.showBusinessSection(true));
        expect(store.getActions()).toEqual(expectedActions);
        expect(store.getActions()).toMatchSnapshot();
    });
    ...
    it('Dispatches the correct action and payload (showProcessorsMemory)', () => {
        const expectedActions = [
            {
        ...
        store.dispatch(Actions.showProcessorsMemory(true));
        expect(store.getActions()).toEqual(expectedActions);
        expect(store.getActions()).toMatchSnapshot();
    });
